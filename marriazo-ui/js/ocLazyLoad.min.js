...
!function (e, n) {
    "use strict";
    var r = ["ng", "oc.lazyLoad"], o = {}, t = [], i = [], a = [], s = e.noop, u = {}, c = [], d = e.module("oc.lazyLoad", ["ng"]);
    d.provider("$ocLazyLoad", ["$controllerProvider", "$provide", "$compileProvider", "$filterProvider", "$injector", "$animateProvider", function (d, l, p, g, m, v) {
        function y(n, o, t) {
            if (o) {
                var i, a, d, l = [];
                for (i = o.length - 1; i >= 0; i--)if (a = o[i], e.isString(a) || (a = j(a)), a && -1 === c.indexOf(a)) {
                    var f = -1 === r.indexOf(a);
                    if (d = h(a), f && (r.push(a), y(n, d.requires, t)), d._runBlocks.length > 0)for (u[a] = []; d._runBlocks.length > 0;)u[a].push(d._runBlocks.shift());
                    e.isDefined(u[a]) && (f || t.rerun) && (l = l.concat(u[a])), $(n, d._invokeQueue, a, t.reconfig), $(n, d._configBlocks, a, t.reconfig), s(f ? "ocLazyLoad.moduleLoaded" : "ocLazyLoad.moduleReloaded", a), o.pop(), c.push(a)
                }
        ...
        function L(n, r) {
            function t(n) {
                return e.isArray(n) ? D(n.toString()) : e.isObject(n) ? D(z(n)) : e.isDefined(n) && null !== n ? D(n.toString()) : n
            }

            var i = n[2][0], a = n[1], u = !1;
            e.isUndefined(o[r]) && (o[r] = {}), e.isUndefined(o[r][a]) && (o[r][a] = {});
            var c = function (e, n) {
                o[r][a].hasOwnProperty(e) || (o[r][a][e] = []), -1 === o[r][a][e].indexOf(n) && (u = !0, o[r][a][e].push(n), s("ocLazyLoad.componentLoaded", [r, a, e]))
            };
            if (e.isString(i))c(i, t(n[2][1])); else {
                if (!e.isObject(i))return !1;
                e.forEach(i, function (n, r) {
                    e.isString(n) ? c(n, t(i[1])) : c(r, t(n))
                })
            }
            return u
        }
        ...
        function $(n, r, o, i) {
            if (r) {
                ...
                for (a = 0, s = r.length; s > a; a++)if (u = r[a], e.isArray(u)) {
                    ...
                    var d = L(u, o);
                    if ("invoke" !== u[1])d && e.isDefined(c) && c[u[1]].apply(c, u[2]); else {
                        var l = function (n) {
                            var r = t.indexOf("" + o + "-" + n);
                            (-1 === r || i) && (-1 === r && t.push("" + o + "-" + n), e.isDefined(c) && c[u[1]].apply(c, u[2]))
                        };
                        if (e.isFunction(u[2][0]))l(u[2][0]); else if (e.isArray(u[2][0]))for (var f = 0, h = u[2][0].length; h > f; f++)e.isFunction(u[2][0][f]) && l(u[2][0][f])
                    }
                }
            }
        }
        ...
        b.push = function (e) {
            ...
            e.isDefined(n.modules) && (e.isArray(n.modules) ? e.forEach(n.modules, function (e) {
                _[e.name] = e
            }) : _[n.modules.name] = n.modules), e.isDefined(n.debug) && (x = n.debug), e.isDefined(n.events) && (O = n.events)
        }, this._init = function (o) {
            if (0 === i.length) {
                var t = [o], s = ["ng:app", "ng-app", "x-ng-app", "data-ng-app"], u = /\sng[:\-]app(:\s*([\w\d_]+);?)?\s/, c = function (e) {
                    return e && t.push(e)
                };
                e.forEach(s, function (n) {
                    s[n] = !0, c(document.getElementById(n)), n = n.replace(":", "\\:"), o[0].querySelectorAll && (e.forEach(o[0].querySelectorAll("." + n), c), e.forEach(o[0].querySelectorAll("." + n + "\\:"), c), e.forEach(o[0].querySelectorAll("[" + n + "]"), c))
                }), e.forEach(t, function (n) {
                    if (0 === i.length) {
                        var r = " " + o.className + " ", t = u.exec(r);
                        t ? i.push((t[2] || "").replace(/\s+/g, ",")) : e.forEach(n.attributes, function (e) {
                            0 === i.length && s[e.name] && i.push(e.value)
                        })
                    }
                })
            }
            ...
            var d = function l(n) {
                if (-1 === r.indexOf(n)) {
                    r.push(n);
                    var o = e.module(n);
                    $(null, o._invokeQueue, n), $(null, o._configBlocks, n), e.forEach(o.requires, l)
                }
            };
        ...
        var z = function (n) {
            var r = [];
            return JSON.stringify(n, function (n, o) {
                if (e.isObject(o) && null !== o) {
        ...
        this.$get = ["$log", "$rootElement", "$rootScope", "$cacheFactory", "$q", function (n, o, t, u, d) {
            function l(e) {
                var r = d.defer();
                return n.error(e.message), r.reject(e), r.promise
            }

            var p, g = u("ocLazyLoad");
            return x || (n = {}, n.error = e.noop, n.warn = e.noop, n.info = e.noop), w.getInstanceInjector = function () {
                return p ? p : p = o.data("$injector") || e.injector()
            }, s = function (e, r) {
                O && t.$broadcast(e, r), x && n.info(e, r)
            }, {
                _broadcast: s, _$log: n, _getFilesCache: function () {
                    return g
                ...
                }, _getModuleName: j, _getModule: function (e) {
                    try {
                        return h(e)
                    } catch (n) {
                        throw(/No module/.test(n) || n.message.indexOf("$injector:nomod") > -1) && (n.message = 'The module "' + z(e) + '" that you are trying to load does not exist. ' + n.message), n
                    }
                }, moduleExists: E, _loadDependencies: function (n, r) {
                    var o, t, i, a = [], s = this;
                    ...
                    return t = s.getRequires(o), e.forEach(t, function (o) {
                        if (e.isString(o)) {
                            ...
                            if (null === t)return void b.push(o);
                            o = t
                        }
                        ...
                        })) : l(new Error("Error: New dependencies need to be loaded from external files (" + o.files + "), but no loader has been defined."));
                        if (e.isArray(o) ? o = {files: o} : e.isObject(o) && o.hasOwnProperty("name") && o.name && (s.setModuleConfig(o), b.push(o.name)), e.isDefined(o.files) && 0 !== o.files.length) {
                            if (!e.isDefined(s.filesLoader))return l(new Error('Error: the module "' + o.name + '" is defined in external files (' + o.files + "), but no loader has been defined."));
                    ...
                    var r = void 0 === arguments[1] ? {} : arguments[1], o = this, t = d.defer();
                    if (e.isDefined(n) && null !== n) {
                        ...
                        o._addToLoadList(o._getModuleName(n), !0)
                    }
                    if (i.length > 0) {
                        var s = i.slice(), u = function l(e) {
                            b.push(e), o._loadDependencies(e, r).then(function () {
                                try {
                                    c = [], y(w, b, r)
                                } catch (e) {
                                    return o._$log.error(e.message), void t.reject(e)
                                }
                                i.length > 0 ? l(i.shift()) : t.resolve(s)
                            }, function (e) {
                                t.reject(e)
                            })
                        };
                ...
                }, _invokeQueue: $, _registerInvokeList: L, _register: y, _addToLoadList: f
            }
    ...
    var f = function (n, r) {
        (a.length > 0 || r) && e.isString(n) && -1 === i.indexOf(n) && i.push(n)
    }, h = e.module;
    ...
    "use strict";
    e.module("oc.lazyLoad").directive("ocLazyLoad", ["$ocLazyLoad", "$compile", "$animate", "$parse", function (n, r, o, t) {
        return {
            restrict: "A", terminal: !0, priority: 1e3, compile: function (i, a) {
                var s = i[0].innerHTML;
                return i.html(""), function (a, u, c) {
                    var d = t(c.ocLazyLoad);
                    a.$watch(function () {
                        return d(a) || c.ocLazyLoad
                    }, function (t) {
    ...
    e.module("oc.lazyLoad").config(["$provide", function (n) {
        n.decorator("$ocLazyLoad", ["$delegate", "$q", "$window", "$interval", function (n, r, o, t) {
            ...
            return n.buildElement = function (u, c, d) {
                var l, f, h = r.defer(), p = n._getFilesCache(), g = function (e) {
                    var n = (new Date).getTime();
                    return e.indexOf("?") >= 0 ? "&" === e.substring(0, e.length - 1) ? "" + e + "_dc=" + n : "" + e + "&_dc=" + n : "" + e + "?_dc=" + n
                };
                switch (e.isUndefined(p.get(c)) && p.put(c, h.promise), u) {
                    case"css":
                        l = o.document.createElement("link"), l.type = "text/css", l.rel = "stylesheet", l.href = d.cache === !1 ? g(c) : c;
                        break;
                    case"js":
                        l = o.document.createElement("script"), l.src = d.cache === !1 ? g(c) : c;
                        break;
                    default:
                        p.remove(c), h.reject(new Error('Requested type "' + u + '" is not known. Could not inject "' + c + '"'))
                }
                l.onload = l.onreadystatechange = function (e) {
                    l.readyState && !/^c|loade/.test(l.readyState) || f || (l.onload = l.onreadystatechange = null, f = 1, n._broadcast("ocLazyLoad.fileLoaded", c), h.resolve())
                }, l.onerror = function () {
    ...
    e.module("oc.lazyLoad").config(["$provide", function (n) {
        n.decorator("$ocLazyLoad", ["$delegate", "$q", function (n, r) {
            return n.filesLoader = function (o) {
                var t = void 0 === arguments[1] ? {} : arguments[1], i = [], a = [], s = [], u = [], c = null, d = n._getFilesCache();
                n.toggleWatch(!0), e.extend(t, o);
                var l = function (r) {
                    var o, l = null;
                    if (e.isObject(r) && (l = r.type, r = r.path), c = d.get(r), e.isUndefined(c) || t.cache === !1) {
                        if (null !== (o = /^(css|less|html|htm|js)?(?=!)/.exec(r)) && (l = o[1], r = r.substr(o[1].length + 1, r.length)), !l)if (null !== (o = /[.](css|less|html|htm|js)?((\?|#).*)?$/.exec(r)))l = o[1]; else {
                            if (n.jsLoader.hasOwnProperty("ocLazyLoadLoader") || !n.jsLoader.hasOwnProperty("load"))return void n._$log.error("File type could not be determined. " + r);
                            l = "js"
                        }
                ...
                if (s.length > 0) {
                    ...
                    n.jsLoader(s, function (r) {
                        e.isDefined(r) && n.jsLoader.hasOwnProperty("ocLazyLoadLoader") ? (n._$log.error(r), p.reject(r)) : p.resolve()
                    }, t), u.push(p.promise)
                }
                if (0 === u.length) {
                    var g = r.defer(), m = "Error: no file to load has been found, if you're trying to load an existing module you should use the 'inject' method instead of 'load'.";
                    return n._$log.error(m), g.reject(m), g.promise
                }
                ...
                var t, i = void 0 === arguments[1] ? {} : arguments[1], a = this, s = null, u = [], c = r.defer(), d = e.copy(o), l = e.copy(i);
                ...
                if (e.isString(d) ? (s = a.getModuleConfig(d), s || (s = {files: [d]})) : e.isObject(d) && (s = e.isDefined(d.path) && e.isDefined(d.type) ? {files: [d]} : a.setModuleConfig(d)), null === s) {
                ...
                var h = e.extend({}, l, s);
                return e.isUndefined(s.files) && e.isDefined(s.name) && n.moduleExists(s.name) ? n.inject(s.name, h) : (n.filesLoader(s, h).then(function () {
